    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '  ✅ CONFIRMED June 17 2026 — BET 2 fully hit, BET 1 partial:',
          '     Yankees 5-1 White Sox ✅ (Yankees ML -190 — Goldschmidt + Rice both homered)',
          '     Medvedev 6-4 6-4 Atmane, Halle ATP ✅ (Medvedev ML — dominant straight sets)',
          '     England 4-2 Croatia ✅ (England ML -145 — Kane brace, Bellingham, Rashford)',
          '     Cubs ML vs Sullivan debut — result unconfirmed (BET 1 status pending Cubs score)',
          '     Pattern: Top ATP grass seed vs #90 = near-lock. Straight sets, efficient.',
          ...
          '',
          '📊 *RUNNING RECORD (June 15–17 2026):*',
          '   June 15: 2/2 bets ✅ 5/5 legs | June 16: 2/2 bets ✅ 4/4 legs',
          '   June 17: BET 2 ✅ (Yankees ML + Medvedev ML) | BET 1 partial pending',
          '   Confirmed: ≥5 bets won / ≤1 open | ~11/12 legs confirmed hit',
          '💰 *BANKROLL GOAL: $600–$700 by end of week*',
          '⚠️  Priority sports: MLB · ATP Tennis (avoid soccer group stage ML)',
        ].join('\n');
