    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '     EXCEPTION: True top-4 team vs clear inferior qualifier (8+ ranking gap)',
          '       Argentina vs Algeria = 77% win, 17% draw, ML is justified',
          '       Check Kalshi/Dimers consensus — if draw% is under 20%, ML is ok',
          '     Use 1X2 market or SKIP soccer if quality gap is close',
