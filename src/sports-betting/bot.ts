    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   June 21: BET 1 ✅ ML WIN — Wheeler + massive 7th inning, Phils beat Mets, sole NL East lead.',
          '              Mets TT result: PENDING FINAL CONFIRMATION (Wheeler dominated vs Peterson, likely ≤2 runs).',
          ...
          '   ✅ June 21 BET 1 RESULT: ML WIN confirmed — Wheeler dominated, Phillies win, sole NL East lead.',
          '      Wheeler was on Sunday Night Baseball vs Peterson (5.91 ERA). Massive 7th inning sealed it.',
          '      Mets TT: PENDING final score confirmation. Wheeler dominance + Peterson suggests ≤2-3 Mets runs.',
          '      If Mets scored ≤3 runs → BOTH LEGS HIT (under 3.5 ✅). Await user final word.',
          ...
          '',
          '📅 *June 24 preview:*',
          '   Skubal (Tigers, 3.02 ERA) eligible on 5-day rest — ERA borderline, June 19 start concerning (3 ER).',
          '   Hunter Brown (Astros) starts June 22 → not June 24.',
          '   Checking closer/opponent matchup before qualifying.',
          '',
          '📅 *June 25 — ACE ROTATION RESETS:*',
          '   THREE elite options line up on 5-day rest from June 20 starts:',
          '   🔥 Sale (Braves, 2.30 ERA, 8-5) | 🔥 Yamamoto (Dodgers, 2.52 ERA) | 🔥 Sanchez (Phillies, 1.82 ERA)',
          '   Expect 1-2 qualifying bets June 25 — confirm matchups + bullpens day-of.',
        ].join('\n');
