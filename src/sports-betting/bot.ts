    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   ✅ NEW PATTERN CONFIRMED: Team total under + starter SGP — both legs hit cleanly.',
          '      Under leg survived bullpen usage because Schlittler was so dominant (5-0 shutout).',
