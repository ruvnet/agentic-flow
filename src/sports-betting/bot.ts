    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   June 20: 0/2 ❌❌ — BET 1 Sanchez bombed (Mets 11-1) | BET 2 Dodgers pen blew (Orioles 4-3 WO)',
          '   June 20 AM: NOT PLACED — Cubs ML (Boyd, 2.79 ERA) morning pick.',
          '   June 20 PM: BET 1 ❌❌ LOST — Mets 11, Phillies 1 (Sanchez 2nd straight blowup; both legs dead).',
          '              BET 2 ❌❌ LOST — Orioles walk-off 4-3 (Yamamoto no-hit bid thru 8, pen blew it).',
          '              Treinen/Scott meltdown in 9th — Scott gave up walk-off single with bases loaded.',
          '              Orioles scored 4 runs (under 3.5 ❌ by 0.5). Covers bullpen warning proved correct.',
          ...
          '      LESSON #6: When Covers/sharp-money sites warn "fade bullpen," ERA of closer is NOT enough.',
