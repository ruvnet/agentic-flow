    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   June 20: NOT PLACED (user forgot) — picks were Cubs ML + Dodgers ML SGPs',
          '            LESSON CONFIRMED: Dodgers bullpen blew a Yamamoto no-hit bid in 9th (Orioles walk-off 4-3)',
          '            LESSON #3: ALWAYS verify closer/bullpen ERA before trusting any ML SGP (June 18 ✦ June 20)',
          '            Phillies bullpen: Duran 1.90 ERA + Kerkering 2.03 ERA = SAFE. Always name the closer.',
          '   June 21: BET 1 ⏳ Phillies ML + Mets TT under 3.5 (Wheeler, SNB 7:20 PM ET)',
          '            BET 2 ⏳ Yankees ML + Reds TT under 3.5 (Cole, 1:35 PM ET)',
          '   ✅ PATTERN CONFIRMED: ML + opponent TT under SGP hits when elite starter AND elite bullpen align.',
          ...
          '📅 *June 21 picks (2-bet day — full cross-sport screen):*',
          ...
          '     Phillies ML true prob: ~67% | Mets TT under 3.5 true prob: ~82% (Poisson λ=2.2 vs Wheeler).',
          '     P(X≤3 | λ=2.2) = e^(-2.2)×[1+2.2+2.42+1.775] = 0.1108×7.395 = 82%. Correlation ✓',
          '     SCREENED: Spain -1111 (group stage, not Argentina/Brazil → skip). Fritz/Tiafoe final →',
          '       50/50 no confirmed edge. Belgium -235, Uruguay — all group stage rule applies.',
          '   BET 2: Yankees ML + Reds TT under 3.5 runs (SGP, 1:35 PM ET, Yankee Stadium)',
          '     Cole 2-1, 2.57 ERA (5 starts into TJS comeback). Last start: 6.2 IP 0 ER 10 Ks.',
          '     vs Reds 35-38 (4 wins in last 14). Yankees 45-28, 10-of-12 recent wins, home.',
          '     RISK: Burns 8-1, 2.01 ERA pitches for Reds (suppresses Yankees scoring too).',
          '     Yankees ML true prob: ~68% | Reds TT under 3.5 true prob: ~76% (Poisson λ=2.5 vs Cole).',
          '     P(X≤3 | λ=2.5) = e^(-2.5)×[1+2.5+3.125+2.604] = 0.0821×9.229 = 75.8%. Correlation ✓',
          '     NOTE: Confirm Yankees closer ERA at your book before placing (Clay Holmes now with Mets).',
          '   ⏳ June 21 results: PENDING — confirm at your book.',
        ].join('\n');
