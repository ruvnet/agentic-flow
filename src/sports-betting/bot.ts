    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '',
          '📊 *RUNNING RECORD (June 15–19 2026):*',
          '   June 15: 2/2 bets ✅ | June 16: 2/2 bets ✅ | June 17: 2/2 bets ✅ ALL 4 legs hit',
          '            (Cubs 8-6, England 4-2, Yankees 5-1, Medvedev) + Colombia DC bonus ✅ (3-1)',
          ...
          '   June 19: BET 1 — Yankees ML + Reds TT under 2.5 (7:05 PM ET) | PENDING',
          '            BET 2 — Tigers ML + Skubal K prop (6:40 PM ET) | PENDING',
          '   ❌ NEW PATTERN: Team total under + starter SGP — safer than ML + RBI prop because',
          '      the under leg cannot be killed by bullpen collapse on the UNDER side.',
          '      Apply when: starter ERA ≤2.50, opponent below-average offense, TT line ≤2.5.',
          ...
          '📅 *June 19 picks:*',
          '   BET 1: Yankees ML (-270, ~73%) + Reds TT under 2.5 (SGP) ✅',
          '     Schlittler 7-3, 1.82 ERA vs Lowder 4.60 ERA. Reds under in 13/19 recent games.',
          '     Schlittler earned runs under in 18/25 starts. Poisson λ=1.8 → P(≤2)=73%. 7:05 PM ET.',
          '   BET 2: Tigers ML (-235, ~70%) + Skubal K prop over (SGP) — 6:40 PM ET',
          '     Skubal post-surgery: 63 Ks/44.2 IP in 8 starts (7.9 Ks avg). Over 5.5→83%; over 6.5→71%.',
          '     Confirm K prop line at your book — both 5.5 and 6.5 qualify.',
          '   SKIPPED: Medvedev -500 ML (neg EV). Straight sets -200 borderline neg EV. Skip tennis.',
          '   SKIPPED: Brewers -178 (model only 50.6%). World Cup group stage (no exceptions today).',
        ].join('\n');
