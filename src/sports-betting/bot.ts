    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   June 20: BET 1 ⏳ Yankees ML + Warren K prop — RESULT PENDING (confirm at your book)',
          '   June 21: BET 1 Phillies ML + Mets TT under 3.5 (Wheeler, SNB) | BET 2 Dodgers ML + Orioles TT under 3.5 (Yamamoto)',
          ...
          '   ⏳ June 20 result: PENDING — confirm Warren K prop result at your book.',
          '📅 *June 21 picks (2-bet day):*',
          '   BET 1: Phillies ML + Mets TT under 3.5 runs (SGP, 7:20 PM ET Sunday Night Baseball)',
          '     Wheeler 6-1, 2.01 ERA, NL Pitcher of Month (62 Ks/62.2 IP, 8.97 K/9).',
          '     vs Mets SP (unconfirmed as of research). Citizens Bank Park home.',
          '     Phillies true prob: 70% | Mets TT under 3.5 true prob: 70% (λ=2.7 vs Wheeler).',
          '     Pattern match: same ML + TT under SGP that hit June 19 (Yankees 5-0 Reds).',
          '   BET 2: Dodgers ML + Orioles TT under 3.5 runs (SGP, ~10 PM ET)',
          '     Yamamoto 7-4, 2.52 ERA, LAST 5 STARTS: 1.01 ERA in 35.2 IP (scorching).',
          '     vs Rogers 3-7, 5.86 ERA. Dodger Stadium home.',
          '     Dodgers true prob: 72% | Orioles TT under 3.5 true prob: 82% (λ=2.2 vs Yamamoto).',
          '     Stats insider model: 68% Dodgers. True prob estimated 72% given Yamamoto hot streak.',
          '   SKIPPED: Fritz ML (Halle final single-leg, no valid 2nd leg). Yankees/Reds G3 ~50/50.',
          '     Astros ML skipped — Teng 3.92 ERA with 4 recent bad starts (not elite matchup).',
          '     All World Cup group stage: standing no-soccer rule applies. Belgium -235 = skip.',
        ].join('\n');
