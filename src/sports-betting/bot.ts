    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   June 18 picks (afternoon research):',
          '     QUALIFIES: Yankees ML -154 (64.4% Dimers), Mariners ML -149 (Woo 2.37 HOME ERA),',
          '                Goldschmidt over 0.5 RBIs (~70% — 9-game streak, 1.3 RBI/game recent)',
          '     REJECTED:  Canada ML (group stage rule + neg EV), Embolo ATS (42%), Ndoye ATS (~24%)',
          '     KEY: Woo career-high 7 ER vs Orioles came at Camden Yards (ROAD). Today = HOME.',
          '          Home ERA 2.37 (elite) vs Road ERA 5.93. Home game = correct leg to back.',
          '     BET 1: Mariners ML + Goldschmidt over 0.5 RBIs (separate games)',
          '     BET 2: Yankees ML (single — only 3 qualifying legs today)',
