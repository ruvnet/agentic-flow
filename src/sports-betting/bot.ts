    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '',
          '📅 *June 25 — ACE ROTATION RESETS (TARGET DAY):*',
          '   THREE elite options return on 5-day rest from June 20 starts:',
          '   🔥 Sale (Braves, 2.30 ERA, 8-5, 92 Ks) | 🔥 Yamamoto (Dodgers, 2.52 ERA) | 🔥 Sanchez (Phillies, 1.82 ERA)',
          '   Full research + bullpen checks run day-of. Expect 1-2 qualifying bets.',
