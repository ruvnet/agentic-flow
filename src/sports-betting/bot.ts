    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '              Mets TT result: PENDING USER CONFIRMATION (Wheeler dominant, likely ≤3 runs).',
          ...
          '      Mets TT result: TBC (Wheeler vs Peterson, likely ≤3 runs — confirm with user).',
          ...
          '📅 *June 22 — Pre-screen (user has no laptop access):*',
          ...
          '     - Yamamoto/Wheeler/Burns/Sale: pitched June 20-21, next start June 25-26',
          '     - Bieber (Blue Jays): 2026 season debut vs Astros — rehab ERA 6.88, first start = high risk, SKIP',
          '     - Nola (Phillies vs Nationals): 5.86 season ERA — FAILS starter quality threshold',
          '   ✅ June 22 STATUS: NO QUALIFYING PICKS FOUND. 0-pick day per quality bar.',
          '      Standing rule enforced: 0 weak picks > 1 forced bet after loss day.',
          '      User to check /rules on June 23 — rotation resets with fresh aces available.',
        ].join('\n');
