    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   June 15: 2/2 bets ✅ 5/5 legs | June 16: 2/2 bets ✅ 4/4 legs',
          '   June 17: 2/2 bets ✅ ALL 4 legs hit (Cubs 8-6, England 4-2, Yankees 5-1, Medvedev)',
          '            + Colombia DC bonus ✅ (3-1 final)',
          '   June 18 RESULTS:',
          '     BET 1: Yankees ML + Goldschmidt RBI ❌ LOST — White Sox 5-1 (Benintendi PH grand slam)',
          '     BET 2: Mariners ML + Woo over 5.5 Ks ✅ BOTH LEGS HIT — Mariners 3-0, Woo 9 Ks',
          '            ⚠️  If BET 2 was skipped due to Rodriguez injury caveat, the calls were correct.',
          '     LESSON: Yankees loss — Benintendi pinch grand slam off Doval (bullpen collapse, not starter)',
          '             Weathers gave up 1 HR in 2nd then was solid. Loss came from late relief. Red flag:',
          '             single-game SGP vulnerable to bullpen variance even when starter qualifies.',
          '   ❌ NEW PATTERN: Book-lined SGP K props — verify K line is under SportsLine projection.',
          '      Woo projection 6.0 vs actual 9 Ks shows OVER was correct. Always check line vs projection.',
          ...
          '📅 *June 19 research:* Medvedev ML vs Altmaier (Halle QF) — 80% prob but -500 odds (neg EV).',
          '   ⚠️  At -500, Medvedev ML needs to be combined in parlay OR find set handicap under -200.',
          '   Brewers (Misiorowski 1.34 ERA) at -178 — model shows 50.6%. Market overpriced. SKIP.',
        ].join('\n');
