    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '',
          '📊 *RUNNING RECORD (June 15–21 2026):*',
          ...
          '            LESSON: bullpen collapse kills ML SGP even when starter qualifies. Check bullpen ERA.',
          '   June 19: BET 1 ✅✅ Yankees 5-0 Reds (Schlittler 13 Ks career high, Reds scored 0)',
          '            BET 2 ✅✅ Tigers 4-3 White Sox (Skubal 8 Ks, Carpenter walk-off bloop double)',
          '   June 20: BET 1 ⏳ Cubs ML + Mariners TT under 3.5 (Boyd vs Kirby, Wrigley, ~2:20 PM ET)',
          '            BET 2 ⏳ Dodgers ML + Orioles TT under 3.5 (Yamamoto vs Rogers, ~10:10 PM ET)',
          '   June 21: BET 1 Phillies ML + Mets TT under 3.5 (Wheeler, SNB 7:20 PM ET) | BET 2 TBD',
          '   ✅ PATTERN CONFIRMED: ML + opponent TT under SGP hits when elite starter dominates.',
          '      Skubal K prop at -102 (book implied 50.5%) vs 71% true prob = massive edge found.',
          '      Key lesson: when K prop line is near even money for a dominant ace, it is a top-tier leg.',
          ...
          '   Prop verification: last 10 games RBI rate, shot volume, starting role, opposition defense.',
          ...
          '   BET 1: Cubs ML + Mariners TT under 3.5 runs (SGP, ~2:20 PM ET, Wrigley Field)',
          '     Boyd 6-3, 2.79 ERA, last start 6/14: 6 IP 1 ER 1 H vs Kirby 1-3, 5.96 ERA.',
          '     Cubs -144 | Cubs ML true prob: ~62% | Mariners TT under 3.5 true prob: ~65% (λ=3.0 vs Boyd).',
          '     Positive correlation: Boyd dominant → Cubs win AND Mariners score ≤3.',
          '     SCREENED: World Cup group stage all skipped (Netherlands -145, Germany -200, Ecuador -809 — rule applies).',
          '     Halle tennis SF: Zverev vs Fritz ~50/50 (skip). Tiafoe SF single-leg only (no valid 2nd correlated leg).',
          '   BET 2: Dodgers ML + Orioles TT under 3.5 runs (SGP, 10:10 PM ET, Dodger Stadium)',
          '     Yamamoto 7-4, 2.52 ERA, LAST 5 STARTS: 4-1, 1.01 ERA in 35.2 IP (scorching).',
          '     vs Rogers 3-7, 5.86 ERA. Dodgers 48-27 (best record AL/NL West).',
          '     Dodgers ML true prob: ~72% | Orioles TT under 3.5 true prob: ~82% (λ=2.2 vs Yamamoto).',
          '     Stats Insider model: 68-70% Dodgers. True prob 72% given Yamamoto hot streak.',
          '     CAUTION: Earlier session mislabeled this game as June 21 — confirmed it is June 20.',
          '   ⏳ June 20 results: PENDING — confirm both at your book after games complete.',
          '📅 *June 21 picks:*',
          '   BET 1: Phillies ML + Mets TT under 3.5 runs (SGP, 7:20 PM ET Sunday Night Baseball)',
          '     Wheeler 6-1, 2.01 ERA, NL Pitcher of Month (62 Ks/62.2 IP, 8.97 K/9) at home.',
          '     Phillies true prob: ~70% | Mets TT under 3.5 true prob: ~71% (λ=2.7 vs Wheeler).',
          '   BET 2: TBD — research June 21 slate for second qualifying game (Dodgers G3 different pitcher).',
        ].join('\n');
