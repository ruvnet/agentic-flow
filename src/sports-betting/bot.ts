    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '     Always pull split ERA before trusting a moneyline favorite’s arm',
          '',
          ...
          '     QUALIFIES: Yankees ML -154 (64.4% Dimers), Mariners ML -149 (Woo 3.02 ERA),',
          '                Goldschmidt over 0.5 RBIs (~70% — 9-game streak, 1.3 RBI/game recent)',
          '     REJECTED:  Canada ML (group stage rule), Embolo ATS (42%), Ndoye ATS (~30%)',
          '     BET 1: Yankees ML + Goldschmidt over 0.5 RBIs (SGP, correlated)',
          '     BET 2: Mariners ML + Switzerland DC 1X (if Swiss match not yet started)',
