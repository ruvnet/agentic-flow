    ...
    switch (cmd) {
      ...
      case 'rules':
        return [
          ...
          '   June 18: 0 bets placed — zero qualifying picks (Braves 53.2%, all soccer group stage)',
          ...
          '📅 *CARRY FORWARD June 19:* Medvedev ML vs Altmaier (Halle QF, ~68%) — confirmed June 19 not June 18',
        ].join('\n');
